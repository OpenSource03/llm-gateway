...
test("follows a newer release of the reviewed major version only", () => {
  assert.equal(acceptedCodexClientVersion("0.157.0", "0.158.1"), "0.158.1");
  assert.equal(acceptedCodexClientVersion("0.157.0", "0.157.3"), "0.157.3");
  assert.equal(acceptedCodexClientVersion("0.157.0", "0.156.9"), "0.157.0");
  assert.equal(acceptedCodexClientVersion("0.157.0", "1.0.0"), "0.157.0");
  assert.equal(
    acceptedCodexClientVersion("0.157.0", "0.159.0-alpha.1"),
    "0.157.0",
  );
  assert.equal(acceptedCodexClientVersion("0.157.0", ""), "0.157.0");
});
