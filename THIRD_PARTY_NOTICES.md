...
1.71.1 from npm during a local image build. LLM Gateway does not vendor its
...
standalone license file, and the reviewed 1.71.1 npm package still ships no
standalone license text. Operators should verify upstream licensing before
